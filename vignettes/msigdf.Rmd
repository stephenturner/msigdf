...
> 2. Human Entrez Gene IDs were mapped to Mouse Entrez Gene IDs, using the [HGNC Comparison of > Orthology Predictions (HCOP)](http://www.genenames.org/cgi-bin/hcop) (downloaded 11 Octtober 2016).
